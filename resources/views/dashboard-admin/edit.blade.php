...
<div class="card shadow mb-4">
    ...
    <div class="collapse show" id="collapseCardExample">
        <form action="/dashboard/{{ $motor->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body col-lg-10">
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="{{ $motor->merkMotor }}" id="merkMotor" name="merkMotor" type="text">
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Biaya Sewa</label>
                        <input class="form-control" value="{{ $motor->harga }}" id="harga" name="harga" type="text">
                    </div>
                    <div class="mb-3">
                        <label for="mesin" class="form-label">Kapasitas Mesin</label>
                        <input class="form-control" value="{{ $motor->mesin }}" id="mesin" name="mesin" type="text">
                    ...
                    <div class="mb-3">
                        <label for="bahanBakar" class="form-label">Bahan Bakar</label>
                        <input class="form-control" value="{{ $motor->bahanBakar }}" id="bahanBakar" name="bahanBakar" type="text">
                    </div>
                    <div class="mb-3">
                        <label for="warna" class="form-label">Warna Motor</label>
                        <input class="form-control" id="warna" value="{{ $motor->warna }}" name="warna" type="text">
                    </div>
                    <div class="mb-3">
                        <label for="speedometer" class="form-label">Jenis Speedometer</label>
                        <input class="form-control" value="{{ $motor->speedometer }}" id="speedometer" name="speedometer" type="text">
                    </div>
                    {{-- <div class="mb-3">
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <input class="form-control" value="{{ $motor->tipe }}" id="tipe" name="tipe" type="text">
                    </div> --}}
                    <div class="mb-3">
                        <label for="tipe" class="form-label">tipe</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="{{ $motor->tahunKeluaran }}" id="tahunKeluaran" name="tahunKeluaran" type="text">
                    </div>
                    <div class="mb-3">
                        <label for="review" class="form-label">Review Motor</label>
                        <textarea id="review" name="review">{{ $motor->review }}</textarea>
                    </div>
                    <div class="mb-3">
