...
<body>
    ...
    <div class="container">
        ...
        <p class="mb-4"> Role anda adalah penyewa, penyewa dapat menambahkan motor yang nantinya akan di tampilkan pada bagian user biasa.</p>
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{ route('landing1.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="collapse show" id="collapseCardExample">
                    <div class="card-body col-lg-10">
                        <div class="mb-3">
                            <label for="merkMotor" class="form-label">Merk Motor</label>
                            <input class="form-control" id="merkMotor" name="merkMotor" type="text" aria-label="default input example">
                        </div>
                        <div class="mb-3">
                            <label for="mesin" class="form-label">Kapasitas Mesin</label>
                            <input class="form-control" id="mesin" name="mesin" type="text" aria-label="default input example">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="bahanBakar" name="bahanBakar" aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="warna" name="warna" type="text" aria-label="default input example">
                        </div>
                        <div class="mb-3">
                            <label for="speedometer" class="form-label">Jenis Speedometer</label>
                            <input class="form-control" id="speedometer" name="speedometer" type="text" aria-label="default input example">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="tahunKeluaran" name="tahunKeluaran" aria-label="Default select example">
